...
const Info = () => {
  return (
    <Container styles="px-0 flex flex-col smallLaptop:gap-16 items-center justify-center w-full mt-16">
      <div className="relative w-full h-96 rounded-[70px] flex items-center">
        ...
        <div className="relative z-20 flex justify-center items-center p-4 tablet:px-16 w-full text-white">
          <div className="flex flex-col gap-5 w-full text-pretty tablet:text-justify">
            <h1 className="font-bold text-2xl tablet:text-3xl tablet">
              Комплексное управление недвижимостью
            </h1>
            <p className="text-[12px] text-pretty tablet:text-justify tablet:text-base font-light">
      ...
      <div className="flex justify-center">
        <p className="font-light text-center border-[3px] border-yellow-500  w-2/3 p-8 mt-8 rounded-full bg-white">
