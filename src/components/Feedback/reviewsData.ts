...
export const reviews: Review[] = [
  ...
  },
  {
    name: "Виктория",
    location: "Дом 383",
    text: "Замечательное место для отдыха! Природа вокруг — просто сказка. Вернемся обязательно.",
  },
  {
    name: "Игорь",
    location: "Дом 384",
    text: "Отдыхали в компании друзей. Уютная атмосфера, чистый дом, все необходимое было под рукой.",
  },
];
