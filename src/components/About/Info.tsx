    ...
    <Container styles="flex mt-32 items-start gap-16 justify-between flex-col smallLaptop:flex-row desktop:mr-40">
      ...
      <div className="flex flex-col gap-8 smallLaptop:w-[652px] text-lg text-justify">
        ...
        <div>
          ...
          аренды домов в Подмосковье мы также предлагаем услуги комплексного
          управления недвижимостью для максимальной эффективности и доходности
          Ваших объектов. Мы гарантируем высокий уровень сервиса благодаря опыту
          и профессионализму нашей команды. В этой сфере мы уже более 3 лет и
          очень любим то, чем занимаемся!
        </div>
