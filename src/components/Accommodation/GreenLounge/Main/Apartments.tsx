    ...
    <Container styles="mt-48 flex flex-col gap-32 mb-12">
      <div className="grid grid-cols-1 largeTablet:grid-cols-2 gap-y-36 gap-x-12">
        <ApartmentCard
          ...
          description="Уютный дом с открытой верандой с панорамными окнами, столом, 2 стульями, собственной баней (оплачивается отдельно) и подогреваемой купелью (оплачивается отдельно).<br><br>В доме: две двуспальные кровати с белоснежным постельным бельем, банные полотенца, набор косметической продукции, тапочки, фен, холодильник с морозильной камерой, кофемашина, чайник и чайные принадлежности, посудомоечная машина, зона барбекю с мангалом и шампура, парковочное место на 2 машины, телевизор и Wi-Fi"
          link="308319"
          images={[
        ...
        <ApartmentCard
          ...
          description="Уютный дом с открытой верандой с панорамными окнами, столом, 6 стульев, собственной баней (оплачивается отдельно) и подогреваемой купелью (оплачивается отдельно).<br><br>В доме: две двуспальные кровати с белоснежным постельным бельем, банные полотенца, набор косметической продукции, тапочки, фен, холодильник с морозильной камерой, кофемашина, чайник и чайные принадлежности, посудомоечная машина, зона барбекю с мангалом и шампура, парковочное место на 2 машины, телевизор и Wi-Fi"
          link="308316"
          images={[
